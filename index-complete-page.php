...
<!--                        <li><a href="#testimonials">What others say</a></li>-->
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="<?php echo get_template_directory_uri(); ?>/img/bg-header.png">
          <div class="container">
    ...
    <div class="container howitworks" id="howitoworks">
        ...
        <div class="row">
            <div class="col-lg-5 step-panel">
                ...
                <div class="step-img"><img class="img-square" src="<?php echo get_template_directory_uri(); ?>/img/step1.png" alt="Generic placeholder image"></div>
            </div><!-- end step1 -->

            <div class="col-lg-2">
                <img class="corner-arrows-0" src="<?php echo get_template_directory_uri(); ?>/img/top-to-bottom.png" />
            </div>
            ...
            <div class="col-lg-5 step-panel">
                ...
                <div class="step-img"><img class="img-square" src="<?php echo get_template_directory_uri(); ?>/img/step2.png" alt="Step 2"></div>
            </div><!-- end step2 -->
        </div><!-- end row -->
        <div class="row"><div class="col-lg-12">&nbsp;</div></div>
        <div class="row">
            <div class="col-lg-3">
                <img class="corner-arrows-4" src="<?php echo get_template_directory_uri(); ?>/img/left-to-top.png" />
            </div>
            ...
            <div class="col-lg-6 step-panel">
                ...
                <div class="step-img"><img class="img-square" src="<?php echo get_template_directory_uri(); ?>/img/step3.png" alt="Step 3"></div>
            </div>
            <div class="col-lg-3">
                <img class="corner-arrows-1" src="<?php echo get_template_directory_uri(); ?>/img/top-to-right.png" />
            </div>
        </div><!-- end row -->
        <div class="row"><div class="col-lg-12">&nbsp;</div></div>
        <div class="row">
            <div class="col-lg-5 step-panel">
                ...
                <div class="step-img"><img class="img-square" src="<?php echo get_template_directory_uri(); ?>/img/step6.png" alt="Generic placeholder image"></div>
            </div>
            ...
            <div class="col-lg-5 step-panel">
                ...
                <div class="step-img"><img class="img-square" src="<?php echo get_template_directory_uri(); ?>/img/step4.png" alt="Generic placeholder image"></div>
            </div>
        </div><!-- /.row -->
        <div class="row"><div class="col-lg-12">&nbsp;</div></div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <img class="corner-arrows-3" src="<?php echo get_template_directory_uri(); ?>/img/bottom-to-left.png" />
            </div>
            <div class="col-lg-6 step-panel">
                <div class="step-text">
                    <h2>Step 5</h2>
                ...
                <div class="step-img"><img class="img-square" src="<?php echo get_template_directory_uri(); ?>/img/step5.png" alt="Generic placeholder image"></div>
            </div>
            <div class="col-lg-3">
                <img class="corner-arrows-2" src="<?php echo get_template_directory_uri(); ?>/img/right-to-bottom.png" />
            </div>
        </div><!-- /.row -->
      </div><!-- end howitworks -->
      ...
      <div class="playnlearn" id="playnlearn">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="myTab1">
                <div class="col-lg-6">
                    <img class="" src="<?php echo get_template_directory_uri(); ?>/img/playnlearn.png" />
                </div>
                <div class="col-lg-6">
            ...
            <div class="tab-pane fade" id="myTab2">
                <div class="col-lg-6">
                    <img class="" src="<?php echo get_template_directory_uri(); ?>/img/playnlearn-parents.png" />
                </div>
                <div class="col-lg-6 ">
                    <div class="  panel panel-primary">
                        <div class="panel-heading">
            ...
            <div class="tab-pane fade" id="myTab3">
                <div class="col-lg-6">
                    <img class="" src="<?php echo get_template_directory_uri(); ?>/img/playnlearn-educators.png" />
                </div>
                <div class="col-lg-6 ">
                    <div class="  panel panel-primary">
                        <div class="panel-heading">
            ...
            <div class="tab-pane fade" id="myTab4">
                <div class="col-lg-6">
                    <img class="" src="<?php echo get_template_directory_uri(); ?>/img/playnlearn-childcounsellors.png" />
                </div>
                <div class="col-lg-6 ">
                    <div class="  panel panel-primary">
                        <div class="panel-heading">
 ...
 <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/Facebook.png" /></a>&nbsp;<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/twitter.png" /></a>&nbsp;<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/Google%20Plus.png" /></a>&nbsp;<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/Pinterest.png" /></a>&nbsp;<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/YouTube.png" /></a>
              </div>
          </div>
<!--          <div class="row">
    ...
    <div class="container testimonials" id="testimonials">
        ...
        <div class="row">
            <h4>Educators</h4>
                <div class="col-lg-4">
                    <div>
                        <img class="img-circle" src="<?php echo get_template_directory_uri(); ?>/img/img-testimonial.png" alt="Generic placeholder image">
        ...
        <div class="row">
            <h4>Parent</h4>
            <div class="col-lg-4">
                <img class="img-square" src="<?php echo get_template_directory_uri(); ?>/img/img-testimonial.png" alt="Generic placeholder image">
                <div>
